...
- `DES003-dynamic-resolution.md` — Dynamic DPR scaling strategy to preserve FPS
- `DES004-pageload-optimization.md` — Lazy scene hydration and startup performance strategy
